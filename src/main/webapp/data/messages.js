var MESSAGES = {
	...
	location_zone_unkown_311: '<div class="inf-location"><div class="inf-name">Zone Finder cannot determine Zone for your address.</div><div>Try alternative address.</div><div class="inf-name">${name}</div></div>',
