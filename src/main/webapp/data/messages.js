var MESSAGES = {
	...
	location_no_zone: '<div class="inf-location"><div class="inf-name">${oem_supplied}</div><div class="inf-name">${name}</div></div>',
	location_zone_order: '<div class="inf-location"><div class="inf-name">${oem_supplied}</div>${order}<div class="inf-name">${name}</div></div>',
	location_zone_unkown: '<div class="inf-location"><div class="inf-name">${oem_supplied}</div><div class="inf-name">${name}</div></div>',
	location_zone_unkown_311: '<div class="inf-location"><div class="inf-name">${oem_supplied}</div><div class="inf-name">${name}</div></div>',
